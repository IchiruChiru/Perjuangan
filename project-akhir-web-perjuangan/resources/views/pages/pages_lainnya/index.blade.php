        ...
        <form action="{{route('proses_register')}}" method="POST" id="regForm">
            {{ csrf_field() }}
                <div class="form-group">
                    ...
                    <input class="form-control py-4" id="inputFirstName" type="text" name="name" placeholder="Nama Anda..." />
                     @if ($errors->has('name'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control py-4" id="inputEmailAddress" type="email" aria-describedby="emailHelp" name="email" placeholder="Email Anda....." />
                    @if ($errors->has('email'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control py-4" id="inputNoTelp" type="text" name="no_telp" placeholder="Nomor Telephone" />
