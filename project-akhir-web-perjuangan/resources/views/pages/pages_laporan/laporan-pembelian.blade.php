            ...
            <table>
                ...
                <tbody>
                    ...
                    @foreach ($transaksiPembelians as $transaksiPembelian)
                        <tr>
                            <td>{{ $no }}</td>
                            <td>{{ $transaksiPembelian->Supplier_id }}</td>
                            <td>{{ $transaksiPembelian->tgl_transaksi }}</td>
                            <td>{{ $transaksiPembelian->sub_total}}</td>
                            ...
                            <td><button class="button-hapus" onclick="konfirmasi(event, {{ $transaksiPembelian->id }})"><i class="fa-solid fa-trash"></i> Hapus</button></td>
                                        ...
                                        <div class="input-group modal-body">
                                            <form action="/dataLaporan Pembelian/update/{{ $transaksiPembelian->id }}" method="post">
                                                {{ csrf_field() }}
                                                    ...
                                                    <input class="input" type="text" value="{{ $transaksiPembelian->Supplier_id }}" name="nama_Laporan Pembelian">
